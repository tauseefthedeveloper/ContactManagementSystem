...
<head>
<meta charset="UTF-8">
<title>Contact Management System || User Registration</title>
...
<body>
	...
	<div
		class="bg-gradient-to-r from-blue-500 via-purple-600 to-pink-500 min-h-screen flex items-center justify-center">
			...
			<form action="Register" method="post" class="space-y-4" id="registerForm">
				...
				<div>
					<label for="name" class="block text-sm font-medium text-gray-700">Full
						...
						class="mt-1 w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
				</div>
